...
class Wallet:
    ...
    def generate_keys(self):
        ...
        return(
            binascii.hexlify(private_key.exportKey(format="DER")).decode('ascii'),binascii.hexlify(public_key.exportKey(format="DER")).decode('ascii')
        )
    ...
    def sign_transaction(self,sender,recipient,amount,memo):
